...
Once the `conda-forge` channel has been enabled, `kaldi, kaldi-cpu, kaldi-cpu-dev, kaldi-cuda, kaldi-cuda-dev` can be installed with `conda`:
...
```
mamba install kaldi kaldi-cpu kaldi-cpu-dev kaldi-cuda kaldi-cuda-dev
```
